/**
 * DragDropGrid Component
 * A drag and drop sortable grid component using @dnd-kit
 */
...
export interface DragDropGridProps<T extends DragDropItem> {
  items: T[]
...
function DragDropGrid<T extends DragDropItem>({
  items,
  onItemsChange,
  renderItem,
